...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                                ...
                                <ul class="pagination mt-3 justify-content-center">
                                    <c:forEach var="page" items="${pageList}">
                                        <li class="page-item ${(currentUserPage eq page) ? 'active' : ''}">
                                            <a class="page-link" href="/demo/user/list/${page}">${page}</a>
                                        </li>
                                    </c:forEach>
                                </ul>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="/demo/user/update" method="post">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <!-- 4) delUid -->
                                    <button class="btn btn-danger" onclick="location.href='/demo/user/delete/'+$('#delUid').val()">삭제</button>
        ...
        <script src="/demo/assets/js/datatables-simple-demo.js"></script>
    </body>
</html>
